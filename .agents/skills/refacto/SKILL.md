---
name: refacto
description: Refactor sans changement de comportement observable. Exige une couverture de test préalable pour garantir la non-régression. À déclencher sur demande de refactor lié à un ticket existant.
---
...
- **Un ticket GitHub Issue** décrivant la cible du refacto, la motivation (dette, lisibilité, perf, conformité aux rules), et le périmètre exact. Si absent, proposer la skill `create-ticket` d'abord.
