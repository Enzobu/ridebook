---
name: create-ticket
description: Crée un ticket propre sur GitHub Issues avec user story, critères d'acceptance testables, Definition of Done et labels. À déclencher quand l'utilisateur exprime un nouveau besoin, bug, refacto ou chore à suivre dans le backlog. Les tickets sont la source de vérité et doivent être liés aux PR.
---
...
4. **Créer** l'issue via `gh issue create --title "..." --body-file /tmp/ticket-body.md --label "type,scope"`.
