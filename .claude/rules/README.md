...
**Source canonique** : ces fichiers. Ils sont chargés via la commande `/rules`.
...
En cas de conflit entre une règle transverse et un `CLAUDE.md` de sous-projet, la règle la plus spécifique l'emporte.
