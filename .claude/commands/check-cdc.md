---
description: Audit de conformité de la solution au Cahier Des Charges Ridebook. Délègue au subagent cdc-reviewer.
argument-hint: [section optionnelle, ex. "6" pour cibler la récupération asynchrone]
---

Lance un audit de conformité au cahier des charges Ridebook via le subagent **cdc-reviewer**.
